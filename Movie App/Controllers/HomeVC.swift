...
class HomeVC: UIViewController {
    ...
    let sectionTextTitles: [String] = ["Trending Movies", "Trending TV", "Popular", "Upcoming Movie", "Top Rated"]
...
extension HomeVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func numberOfSections(in tableView: UITableView) -> Int {
        return sectionTextTitles.count
    }
    ...
    func tableView(_ tableView: UITableView, willDisplayHeaderView view: UIView, forSection section: Int) {
        ...
        header.textLabel?.frame = CGRect(x: header.bounds.origin.x + 25, y: header.bounds.origin.y, width: 100, height: header.bounds.height)
    ...
    func tableView(_ tableView: UITableView, titleForHeaderInSection section: Int) -> String? {
        return sectionTextTitles[section]
    }
